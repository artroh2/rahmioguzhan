  ...
  return (
    <div className="relative min-h-screen pb-24">
      ...
      <div className="relative z-10 px-6 pt-12">
        ...
        >
          <h1 className="font-display text-8xl font-bold text-primary mb-1">Music</h1>
          <p className="text-[20px] tracking-[0.4em] uppercase text-muted-foreground mb-8">Songs & Albums</p>
        </motion.div>
        ...
        >
          <h2 className="text-xs tracking-[0.3em] uppercase text-muted-foreground mb-4">All Albums & Songs</h2>
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">All albums and singles</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-foreground group-hover:text-primary transition-colors">
                    Apple Music — All Music
                  </h3>
                  <p className="text-xs text-muted-foreground">Apple Music library</p>
                </div>
              </div>
              <ExternalLink size={14} className="text-muted-foreground group-hover:text-primary transition-colors" />
            </a>
