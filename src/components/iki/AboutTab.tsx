...
const socialLinks = [
  {
    name: 'Spotify',
    color: '#1DB954',
    url: 'https://open.spotify.com/artist/5nGIFgo8KRwUln8MAgmOsX',
    icon: (
  ...
  },
  {
    name: 'Instagram',
    color: '#E1306C',
    url: 'https://instagram.com/rahmioguzhan',
    icon: (
  ...
  },
  {
    name: 'LinkedIn',
    color: '#0A66C2',
    url: 'https://linkedin.com/in/rahmioguzhan',
    icon: (
...
const MAILTO = 'mailto:roh@rahmioguzhan.com?subject=İletişim — İKİ&body=Merhaba Oğuzhan,';
    ...
    <div className="relative min-h-screen pb-24">
      ...
      <div className="relative z-10 px-6 pt-12">
        ...
        >
          ...
          <p className="text-[20px] tracking-[0.4em] uppercase text-muted-foreground mb-8">Rahmi Oğuzhan Hacıeyüpoğlu ile iletişime geçin</p>
        </motion.div>
