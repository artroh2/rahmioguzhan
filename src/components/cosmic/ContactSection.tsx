...
const ContactSection = ({ lang }: ContactSectionProps) => {
  ...
  return (
    <section id="iletisim" className="relative py-24 sm:py-32">
      <div className="absolute inset-0 bg-[#08102a]/30" />
      <div className="absolute inset-x-0 top-0 h-48 bg-gradient-to-b from-[#0a1035]/50 via-[#08102a]/30 to-transparent z-[1]" />
