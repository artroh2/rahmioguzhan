        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          {TRACKS.map((track, i) => (
            <motion.div
              ...
              className="rounded-2xl p-5 group bg-transparent border-none transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_30px_hsl(213_100%_65%/0.15),0_0_60px_hsl(213_100%_65%/0.05)]"
            >
