        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 rounded-full bg-[#0A66C2]/20 flex items-center justify-center hover:bg-[#0A66C2]/30 transition-colors"
              aria-label="LinkedIn"
            >
            ...
            <motion.a
              ...
              whileHover={{ y: -3, scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 rounded-full bg-[#1DB954]/20 flex items-center justify-center hover:bg-[#1DB954]/30 transition-colors"
              aria-label="Spotify"
            >
            ...
            <motion.a
              ...
              whileHover={{ y: -3, scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 rounded-full bg-[#E4405F]/20 flex items-center justify-center hover:bg-[#E4405F]/30 transition-colors"
            ...
            <motion.a
              ...
              aria-label="Şiir Kitabı"
            >
              <BookOpen className="w-5 h-5 text-primary" />
            </motion.a>

            <motion.a
              href="https://wa.me/905457929876?text=Merhaba%2C%20web%20sitenizden%20ula%C5%9F%C4%B1yorum."
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ y: -3, scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
