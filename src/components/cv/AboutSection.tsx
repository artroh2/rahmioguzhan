...
const socialLinks = [
  ...
  },
  {
    ...
    label: 'Instagram',
    description: { tr: 'Kişisel instagram sayfam.', en: 'My personal Instagram page.' },
    color: '#E4405F',
    icon: (
  ...
  },
  {
    ...
    label: 'X',
    description: { tr: 'Tweetlere erişim buradan.', en: 'Access my tweets here.' },
    color: null,
    icon: (
  ...
  },
  {
    ...
    label: 'SoundCloud',
    description: { tr: 'Üyelik ve ücret istemeden tüm şarkıları bir arada bulabileceğiniz alternatif müzik platformu.', en: 'An alternative music platform where you can find all songs together without membership or fees.' },
    color: '#FF5500',
    icon: (
  ...
  },
  {
    ...
    label: 'LinkedIn',
    description: { tr: 'Profesyonel çalışma hayatımın bilgilerinin olduğu platform.', en: 'The platform with my professional career information.' },
    color: '#0A66C2',
    icon: (
  ...
  },
  {
    ...
    label: 'WhatsApp',
    description: { tr: 'WhatsApp numaram işte.', en: 'Here\'s my WhatsApp number.' },
    color: '#25D366',
    icon: (
