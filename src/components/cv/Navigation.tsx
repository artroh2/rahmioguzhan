...
import { Eye, Globe, Headphones, BookOpen } from 'lucide-react';
      ...
      <div className="container max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            {/* Social Links */}
            <motion.a href="https://linkedin.com/in/rahmioguzhan" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="w-8 h-8 rounded-full bg-[#0A66C2]/20 flex items-center justify-center hover:bg-[#0A66C2]/30 transition-colors" aria-label="LinkedIn">
            ...
            <motion.a href="https://open.spotify.com/intl-tr/artist/4fQ8VbreLSA4Eaiwm1Elfk?si=Ms6HzdJRRva1rsW9TaArMw" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="w-8 h-8 rounded-full bg-[#1DB954]/20 flex items-center justify-center hover:bg-[#1DB954]/30 transition-colors" aria-label="Spotify">
            ...
            <motion.a href="https://open.spotify.com/intl-tr/artist/0whSI742dh4gkq4ktJsGCW?si=vK7tYRe1RlyiH4rswIRqlA" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="w-8 h-8 rounded-full bg-[#1DB954]/20 flex items-center justify-center hover:bg-[#1DB954]/30 transition-colors" aria-label="Spotify Artist">
              <Headphones className="w-4 h-4 text-[#1DB954]" />
            </motion.a>
            <motion.a href="https://x.com/roguzhanh" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="w-8 h-8 rounded-full bg-foreground/10 flex items-center justify-center hover:bg-foreground/20 transition-colors" aria-label="X">
