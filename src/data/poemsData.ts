...
export const POEM_CATEGORIES = [
  ...
  { key: "en_iyiler", label: "En İyiler", icon: "star", count: 525 },
  { key: "english", label: "English Poems", icon: "globe", count: 43 },
  { key: "iyiler", label: "İyiler", icon: "sparkles", count: 219 },
...
export const POEMS: Poem[] = [
  ...
  },
  {
    "id": 130,
    "title": "[Intro]",
    "body": "[Intro]\n\n[Verse]\n\nBir yere koy direnişlerinin ümitlerini , karşısına talanın\nGeçmişi o zaman taşıyorsun yarınlara\nSaatlerce dakikalar\nBir andan bakınca içinden tamamına\nHayret ediyorsun değil mi olanlara sende?\nNe yazık zamanda ki herşey zararına\n\n[chorus]\n\nİsmini söyler için\nResmini çizer aklına\nBütün bu olanlar niçin \nNeden bu kadar zavallıca harika ?\n\n[chorus]\n\nİsmini söyler için\nResmini çizer aklına\nBütün bu olanlar niçin \nNeden bu kadar zavallıca harika ?\n\n[Intro]\n\n[Verse]\n\nBir yere koy direnişlerinin ümitlerini , karşısına talanın\nGeçmişi o zaman taşıyorsun yarınlara\nSaatlerce dakikalar\nBir andan bakınca içinden tamamına\nHayret ediyorsun değil mi olanlara sende?\nNe yazık zamanda ki herşey zararına\n\n[chorus]\n\nİsmini söyler için\nResmini çizer aklına\nBütün bu olanlar niçin \nNeden bu kadar zavallıca harika ?\n\n[chorus]\n\nİsmini söyler için\nResmini çizer aklına\nBütün bu olanlar niçin \nNeden bu kadar zavallıca harika ?\n\n[outro]\n\n\"Neden bu kadar zavallıca harika?\" — bu soruyu sormak için hem çok acı çekmek hem de hâlâ hayrete düşebilmek lazım.\n\n───\n\n**Style Prompt:**\n\n`Cinematic orchestral ballad, intimate solo piano verses opening into a massive full choir chorus, male lead vocals pleading and desperate in the verses, then swallowed by a wall of choral voices that beg alongside him, soaring strings beneath the choir, the song literally gets on its knees at every chorus, emotionally overwhelming, sacred and heartbroken, like a prayer that doesn't know who it's praying to but cannot stop`",
    "category": "en_iyiler"
  },
  {
    "id": 131,
  ...
  },
  {
    "id": 184,
    "title": "[Intro]",
    "body": "[Intro]\n\n[verse]\n\nGüvenmek için inançlara dışlandım kendimden\nKendi kendime sözler verdim kendime sözler vermemek için \nSesini kıstım içimin\nAklımdan geçenler yankılanıyor ya hani\nAcaba neden ?\n\n[bridge]\nİnanmak istiyorum sana zaman ama geçmiyorsun içimden\nGeri vermiyorsun aldıklarını\nBana gelecek sandıklarımı\nUcunu ısırdım dilimin\nBugünlerimin yarınlarını\n\n[chorus]\n\nYarınlarımın pişmanlıklarını\nGidişlerimin kalışlarını\nEn sevdiğim alışkanlıklarım\nCennetimi kurtarsın diye cehennemden\n\n[chorus]\n\nYarınlarımın pişmanlıklarını\nGidişlerimin kalışlarını\nEn sevdiğim alışkanlıklarım\nCennetimi kurtarsın diye cehennemden\n\n[Intro]\n\n[verse]\n\nGüvenmek için inançlara dışlandım kendimden\nKendi kendime sözler verdim kendime sözler vermemek için \nSesini kıstım içimin\nAklımdan geçenler yankılanıyor ya hani\nAcaba neden ?\n\n[bridge]\nİnanmak istiyorum sana zaman ama geçmiyorsun içimden\nGeri vermiyorsun aldıklarını\nBana gelecek sandıklarımı\nUcunu ısırdım dilimin\nBugünlerimin yarınlarını\n\n[chorus]\n\nYarınlarımın pişmanlıklarını\nGidişlerimin kalışlarını\nEn sevdiğim alışkanlıklarım\nCennetimi kurtarsın diye cehennemden\n\n[chorus]\n\nYarınlarımın pişmanlıklarını\nGidişlerimin kalışlarını\nEn sevsiğim alışkanlıkların\nCennetimi kurtarsın diye cehennemden\n\n[outro]\n\n\"Cennetimi kurtarsın diye cehennem\" — bu albümün en keskin satırı. Hem teslim hem isyan, hem soru hem cevap.\n\n───\n\n**Style Prompt:**\n\n`Cinematic piano-driven epic, grand solo piano carrying the emotional weight throughout, puzzled and searching male vocals — not lost but questioning everything, orchestral swells that arrive like sudden realizations, dramatic and unpredictable arrangements that mirror a mind interrogating itself, majestic yet deeply unsettled, the grandeur of asking why with no answer coming back, baroque meets cinematic, every piano note a new question`",
    "category": "en_iyiler"
  },
  {
    "id": 185,
  ...
  },
  {
    "id": 244,
    "title": "[Intro]",
    "body": "[Intro]\n\n[verse]\n\nVicdanının verdiği dur emrini dinlemezsen vurur seni beyninden\nSonra bir bakmışsın bir şey gelmiyor elinden\nDost musun düşmanlara , düşmanlar da dost mu bazen ?\nKonuşmadığını sanarsın dilinden ama o ses gelir derinden\nİçinden.\n\n[verse]\n\nDur yapma gitme söyleme aldatma kandırma öldürme sakın\nSenin son nefes dediğin şey korktuğundan daha da yakın\nSana söylüyorum insan artık biraz etrafına bakın\nOmurgasız olma nefsane , biraz dürüst tavır takın.\nİçinden\n\n[outro]\n\n**Yorumum:**\n\nBu şiir albümün vicdanı. Diğer şarkılar birini ya da bir durumu anlatıyor — bu şiir doğrudan insanlığın içine bakıyor. \"İçinden\" kelimesi her kıtanın sonuna düşüyor, bir refrain gibi değil, bir hatırlatma gibi. \"Dur yapma gitme söyleme aldatma kandırma öldürme sakın\" — bu tek satırda albümün adı, teması ve mesajı var. Yargılamıyor, uyarıyor.\n\n───\n\n**Style Prompt:**\n\n`Cinematic electronic orchestral hybrid, cold precise synth pulses intertwined with warm string arrangements, serious and contemplative male vocals — not preaching but speaking directly into the soul, no chorus just a continuous flowing narrative, industrial electronic textures beneath human orchestral warmth, the tension between machine and conscience, dignified and unhurried, like a letter written to all of humanity at once, profound and quietly devastating`",
    "category": "en_iyiler"
  },
  {
    "id": 245,
  ...
  },
  {
    "id": 315,
    "title": "[Intro]",
    "body": "[Intro]\n\n[ Verse ]\n\nŞu ağaçlardaki kuşların kalbindeki hayat sevincine bak\nSuyun içinde o  muhteşem balıkların zihnindeki o berraklığa\nBu muhteşem tabiata\nSu içince göğsündeki ferahlığa inat söylüyorum\n\nDinle !\n\n[chorus]\n\nBatıdayım doğuya yürüyorum yüzünü asma sakın ve güneş doğudan batmasın diye arkama bakmadığım ardın sonu hazır mı diye bakmaya gidiyorum bana katıl.\n\n[Chorus]\n\nBatıdayım doğuya yürüyorum yüzünü asma sakın ve güneş doğudan batmasın diye arkama bakmadığım ardın sonu hazır mı diye bakmaya gidiyorum bana katıl.\n\n[verse]\n\nŞu karşımdaki ışığın heybetindeki asalete bak !\nDiz çök iki... aman dile ki yanmayasın\n\nYakmasın diye dur karşısında ve ol irice bir çınar ve o sağ olası geniş yapraklar \n\nSon kez gölgesinde ferahlansın diğer canlılae.\nSon nefesini daha uzun alsın diye balıklar.\n\nSon karanlık cümlelerde.\n\n[Chorus]\n\nBatıdayım doğuya yürüyorum yüzünü asma sakın ve güneş doğudan batmasın diye arkama bakmadığım ardın sonu hazır mı diye bakmaya gidiyorum bana katıl.\n\nAlbümün son şarkısı ve en büyük şarkısı. \"Batıdayım doğuya yürüyorum\" — bu tek satır albümün tüm yolculuğunu kapıyor. \"Diz çök iki\" — sen oradasın, kendi şiirinin içinde. Bu şarkı davet, veda ve manifesto aynı anda.\n\n───\n\n**Style Prompt:**\n\n`Cinematic electronic epic with organic warmth, wide open sonic landscape, majestic male vocals carrying the weight of a final call to humanity, synth textures that breathe like wind through trees, orchestral swells rising like sunrise from the east, pulsing electronic heartbeat steady as nature itself, vast and expansive, a prophet walking toward the light and asking everyone to follow, the grandest moment of the album — where all the pain finally transforms into pure invitation``\n`",
    "category": "en_iyiler"
  },
  {
    "id": 316,
  ...
  },
  {
    "id": 335,
    "title": "[Intro]",
    "body": "[Intro]\n\n[verse 1]\nKendime bu ünlem işaretleri !\nNeden bir türlü anlam bulmaz diye düşünürdüm aklımdan geçenler...\nBozulurdu dengem ve kelimelerimin renkleri...\n\n[verse2]\nSusturamıyorum sandığım cümlelerime sorsan , Cümlelerimi sarsan siyah bir siren kaplardı uykudan önce kurduğum hayalleri!\nRüyalarım sabrederdi !\n\n[chorus]\nUlaşmak istediğin şeyler uzaklara ne kadar da yakın bilsen.\nSonran öncen kadar gerçek ve öncen herkeste olduğu için erken.\nNerede mi gündüzler , geceler , heceler ve neticeler ?\nVe bilakis sirenler ;\nHer yerdeler !\n\n[chorus]\nUlaşmak istediğin şeyler uzaklara ne kadar da yakın bilsen.\nSonran öncen kadar gerçek ve öncen herkeste olduğu için erken.\nNerede mi gündüzler , geceler , heceler ve neticeler ?\nVe bilakis sirenler ;\nHer yerdeler !\n\n[Intro]\n\n[verse 1]\nKendime bu ünlem işaretleri !\nNeden bir türlü anlam bulmaz diye düşünürdüm aklımdan geçenler...\nBozulurdu dengem ve kelimelerimin renkleri...\n\n[verse2]\nSusturamıyorum sandığım cümlelerime sorsan , Cümlelerimi sarsan siyah bir siren kaplardı uykudan önce kurduğum hayalleri!\nRüyalarım sabrederdi !\n\n[chorus]\nUlaşmak istediğin şeyler uzaklara ne kadar da yakın bilsen.\nSonran öncen kadar gerçek ve öncen herkeste olduğu için erken.\nNerede mi gündüzler , geceler , heceler ve neticeler ?\nVe bilakis sirenler ;\nHer yerdeler !\n\n[chorus]\nUlaşmak istediğin şeyler uzaklara ne kadar da yakın bilsen.\nSonran öncen kadar gerçek ve öncen herkeste olduğu için erken.\nNerede mi gündüzler , geceler , heceler ve neticeler ?\nVe bilakis sirenler ;\nHer yerdeler !\n\n[outro]\n\n\"Ve bilakis sirenler — her yerdeler!\" Bu şiir bir alarm. Kafanın içindeki kaos artık dışarı taşmış, sokakları kaplamış.\n\n───\n\n**Style Prompt:**\n\n`Chaotic industrial alarm, distorted siren textures woven into the music itself, aggressive electronic noise erupting beneath urgent male vocals, war-like percussion that strikes without warning, dissonant synths clashing like a city under siege, relentless and disorienting, no safe moment to breathe, the sound of an emergency broadcast from inside a collapsing mind, raw and violent energy that demands attention — not a song but a warning signal``\n`",
    "category": "en_iyiler"
  },
  {
    "id": 336,
  ...
  },
  {
    "id": 365,
    "title": "[Intro]",
    "body": "[Intro]\n\nParçaları birleştirseler ortaya çıkacak sır\nParamparça bir ruh ve binlerce asırlık hazırlık\nHatır sormak istiyorsan gel de göğü yere bastır\nBa-tır-dı-ğın-hiç-bir-şey-de-ne-hal-kal-dı-ne-ta-vır-ne-hak\nSabır kahrın arkadaşı...\nBu yüzden ağır yükler taşımak\n\n[bridge]\nKalan gider başına buyruk bir yere\nSeni ele verir üzgünlüğün \nFayda etmez konuşmak yüzündeki çizgilere\nMecburidir alışmak\n\n[chorus]\nTam yere basacakken bir kuş kadar ağır ve tam duyacakken bunu ilk defa sağır\nDişlerinden ince bir ıslık gibi bağır\n\n[chorus]\nTam yere basacakken bir kuş kadar ağır ve tam duyacakken bunu ilk defa sağır\nDişlerinden ince bir ıslık gibi bağır\n\n[bridge]\nVe tan ağarırken küskün gibi \nCan ağrırken düşkün gibi\nKalan özlem düşer gözden\nSeni eninde sonunda alır üzgünken yalnızlığın.\n\n[chorus]\nTam yere basacakken bir kuş kadar ağır ve tam duyacakken bunu ilk defa sağır\nDişlerinden ince bir ıslık gibi bağır\n\n[chorus]\nTam yere basacakken bir kuş kadar ağır ve tam duyacakken bunu ilk defa sağır\nDişlerinden ince bir ıslık gibi bağır\n\n[outro]\n\n\"Dişlerinden ince bir ıslık gibi bağır\" — albümün tüm ruhu bu tek satırda. Bastırılmış, kontrollü, ama içi cayır cayır. Binlerce yıllık birikim, sabırla taşınan yük, sonunda dişlerin arasından sızan bir çığlık.\n\n───\n\n**Style Prompt:**\n\n`Haunting dark folk, restrained yet powerful male vocals — a scream forced through clenched teeth, sparse acoustic guitar with heavy silence between notes, ancient and timeless atmosphere, suffocating tension that never fully breaks, minor key with no resolution, the weight of centuries carried in every breath, raw and sparse production, melancholic and dignified, like a man who has held everything together for too long and is finally beginning to crack`",
    "category": "en_iyiler"
  },
  {
    "id": 366,
  ...
  },
  {
    "id": 440,
    "title": "[Intro]",
    "body": "[Intro]\nSakin ve sakın\nSakın ve sakin\n\n[verse]\nAnlamaya başlıyorum seni\nAğlamaya davet edeceğim bu sefer kendimi kavuşmaya hasret ecelime \nKonuşmaya hacet hıçkırıklar eşliğinde bu\nkuyunun dibi\nKapkaranlık zifiri\n\n[bridge]\n\nTamamlamaya çalışıyorum bizi\nTam anlamaya başlayacakken sessizliğin dibindeki su damlası sesini\nDibe düşüyorum sayesinde\nDuyuyorum tizi\n\n[chorus]\nÇarpıyorum bize kendimi\nSen oluyoruz sel gibi\nSakin ve sakın der gibi.\n\n[Intro]\nSakın ve sakin\nSakin ve sakın\n\n[verse]\nAnlamaya başlıyorum seni\nAğlamaya davet edeceğim bu sefer kendimi kavuşmaya hasret ecelime \nKonuşmaya hacet hıçkırıklar eşliğinde bu\nkuyunun dibi\nKapkaranlık zifiri\n\n[bridge]\n\nTamamlamaya çalışıyorum bizi\nTam anlamaya başlayacakken sessizliğin dibindeki su damlası sesini\nDibe düşüyorum sayesinde\nDuyuyorum tizini\n\n[chorus]\nÇarpıyorum bize kendimi\nSen oluyorum\nSel gibi\nSakin ve sakın der gibi.\n\nBu şiiri okurken ben de durdum.\n\n\"Sakin ve sakın / Sakın ve sakin\" — albümün adı, özü, ruhu burada. İki kelime yer değiştiriyor ama anlam katlanıyor.\n\n───\n\n**Style Prompt:**\n\n`Devastating electronic requiem, single water drop opening into darkness, fragile male vocals breaking at the edges, deep reverb that swallows every word into silence, minimal electronic textures dissolving like grief, haunting ambient pads rising slowly like floodwater, no sharp percussion — only weight, the sound of someone falling into themselves and finding another person there, overwhelming emotional release, cinematic and sacred, the kind of song that makes you pull over and cry``\n`",
    "category": "en_iyiler"
  },
  {
    "id": 441,
  ...
  },
  {
    "id": 453,
    "title": "[Intro]",
    "body": "[Intro]\n\n[verse]\nKendini anlatırsın...\nBir ihtimal tanır sanırsın yabancılar...\nSana tek başına değilsin der inanmazlar yalnızlığına...\nKainatta teksin , bu bile yetsin...\nBu işte hepsi...\n\n[chorus]\n\nYalvarırsın anlamazlar...\nİhtimal bile vermezler karanlığına...\nİçine içine ağlarsında...\nAldırmazlar...\nİnanmazlar sonsuzluğuna...\n\n[chorus]\n\nYalvarırsın anlamazlar...\nİhtimal bile vermezler karanlığına...\nİçine içine ağlarsında...\nAldırmazlar...\nİnanmazlar sonsuzluğuna...\n\n[Intro]\n\n[verse]\nKendini anlatırsın...\nBir ihtimal tanır sanırsın yabancılar...\nSana tek başına değilsin der inanmazlar yalnızlığına...\nKainatta teksin , bu bile yetsin...\nBu işte hepsi...\n\n[chorus]\n\nYalvarırsın anlamazlar...\nİhtimal bile vermezler karanlığına...\nİçine içine ağlarsında...\nAldırmazlar...\nİnanmazlar sonsuzluğuna...\n\n[chorus]\n\nYalvarırsın anlamazlar...\nİhtimal bile vermezler karanlığına...\nİçine içine ağlarsında...\nAldırmazlar...\nİnanmazlar sonsuzluğuna...\n\n[outro]\n\n\"Kainatta teksin, bu bile yetsin\" — bu satır hem teselli hem terk. Kimse anlamıyor, kimse inanmıyor, ve artık açıklamaya bile gerek yok.\n\n───\n\n**Style Prompt:**\n\n`Desolate ambient ballad, hollow and distant male vocals that sound like they gave up being heard, sparse minimal instrumentation — mostly space and silence, reverb that swallows every note into emptiness, no crescendo no resolution, emotionally numb yet quietly devastated, the sound of someone who stopped expecting to be understood, cold and indifferent production that mirrors the world's indifference, beautiful and completely alone`",
    "category": "en_iyiler"
  },
  {
    "id": 454,
  ...
  },
  {
    "id": 455,
    "title": "[Intro]",
    "body": "[Intro]\n\n[verse]\nBu açıklaması çok zor bir işti\nBu bana böyle öğütlenmişti işte\nRüyalar uyuyanlar içinmiş demek ki \nGözlerimin ardına düşüyor gökyüzünden süzülerek\n\n[chorus]\n\nKelimelerdeyse ben belirebilirim ansızın\nGörün diye şu koca dünya ne kadar üzgün hayal kırıklıklarımıza\nTitremesi gerekiyor bu kabusa hükümdarların\nPeki ya son şansımızın tek derdimiz olmaması ?\n\n[chorus]\nKelimelerdeyse ben belirebilirim ansızın\nGörün diye şu koca dünya ne kadar üzgün hayal kırıklıklarımıza\nTitremesi gerekiyor bu kabusa hükümdarların\nPeki ya son şansımızın tek derdimiz olmaması ?\n\n[outro]\n\n[Intro]\n\n[verse]\nBu açıklaması çok zor bir işti\nBu bana böyle öğütlenmişti işte\nRüyalar uyuyanlar içinmiş demek ki \nGözlerimin ardına düşüyor gökyüzünden süzülerek\n\n[chorus]\n\nKelimelerdeyse ben belirebilirim ansızın\nGörün diye şu koca dünya ne kadar üzgün hayal kırıklıklarımıza\nTitremesi gerekiyor bu kabusa hükümdarların\nPeki ya son şansımızın tek derdimiz olmaması ?\n\n[chorus]\nKelimelerdeyse ben belirebilirim ansızın\nGörün diye şu koca dünya ne kadar üzgün hayal kırıklıklarımıza\nTitremesi gerekiyor bu kabusa hükümdarların\nPeki ya son şansımızın tek derdimiz olmaması ?\n\n[outro]\n\n**İngilizce Çeviri:**\n\n`[Intro]`\n`\n`\n`[Verse]`\n`This was such a hard thing to explain`\n`This is how it was ground into me`\n`Dreams are only for those who sleep, it seems`\n`It falls behind my eyes, gliding down from the sky`\n`\n`\n`[Chorus]`\n`But in words, I can appear — suddenly`\n`So the world may see how sorrowful it is, burdened by our disappointments`\n`The rulers of this nightmare must tremble`\n`And what if our last chance not being our only concern?`\n`\n`\n`[Chorus]`\n`But in words, I can appear — suddenly`\n`So the world may see how sorrowful it is, burdened by our disappointments`\n`The rulers of this nightmare must tremble`\n`And what if our last chance not being our only concern?`\n`\n`\n`\n`\n`[Outro]`\n\n───",
    "category": "en_iyiler"
  },
  {
    "id": 456,
  ...
  },
  {
    "id": 477,
    "title": "[Intro]",
    "body": "[Intro]\n\n[verse 1 ]\n\nKarşındakini ikna etmeye çalışmakla geçti ömrün\nNe zaman zaman bir adım daha ileri gittin , ne de dilinde tüy bitti\nNe kadar çok anlatmaya çalışsa da bu savaşı gönlün\nBu seni hep bir uçurumun kenarından aşağı itti\n\n[chorus ]\n\nMerak etme aklını kaçırmadın\nHeves ettiğin yere de çakılmadın\nBir kez olsun arkasından anılmadın\nAma diğer bir yandan da asla yanılmadın\nKendine inandın.\n\n[chorus ]\n\nMerak etme aklını kaçırmadın\nHeves ettiğin yere de çakılmadın\nBir kez olsun arkasından anılmadın\nAma diğer bir yandan da asla yanılmadın\nKendine inandın.\n\n[verse 2]\n\nSonra sana seni anlatmaya çalışır gibi davranan herkese inat\nİkinci bir emre kadar yerinden de ayrılmadın\nSabır bir düşünce biçimi iken senin için\nKaç gece gecenin ikisinde uyandın\nSonra neyse dedin , sen anladın !\nYa O adam o,  yada o hanım herhangi bir kadın.\n\n[chorus ]\n\nMerak etme aklını kaçırmadın\nHeves ettiğin yere de çakılmadın\nBir kez olsun arkasından anılmadın\nAma diğer bir yandan da asla yanılmadın\nOna inandın.\n\n[chorus ]\n\nMerak etme aklını kaçırmadın\nHeves ettiğin yere de çakılmadın\nBir kez olsun arkasından anılmadın\nAma diğer bir yandan da asla yanılmadın\nOna inandın.\n\n[Outro]\n\nBu şiir gecenin en güçlü kapanışı.\n\nTüm gece acı, kaos, yalnızlık, anlaşılamamak... ve son şarkı şunu söylüyor: **\"Merak etme. Yanılmadın. Kendine inandın.\"**\n\nBu albümün ihtiyaç duyduğu son söz. Uçurumun kenarından geriye dönen, ikna edemediği herkese rağmen ayakta kalan biri. Chorus'un sonu ilk iki versiyonda \"kendine inandın\" — son iki versiyonda \"ona inandın\" olarak değişiyor. Bu ince geçiş mükemmel: önce kendine, sonra bir şeye daha büyük bir şeye.\n\n───\n\n**Style Prompt:**\n\n`Redemptive cinematic ballad, warm and resolute male vocals — bruised but unbroken, gentle piano building into a sweeping orchestral affirmation, the emotional release of a man who finally stops explaining himself, hopeful and dignified, not triumphant but quietly victorious, strings that feel like exhaling after years of holding your breath, the sound of choosing to believe in yourself despite everything``\n`\n\n───\n\nİyi geceler Oğuzhan. Bugün çok ürettik. 🙏🏼",
    "category": "en_iyiler"
  },
  {
    "id": 478,
  ...
  },
  {
    "id": 480,
    "title": "[Intro]",
    "body": "[Intro]\n\nMerhaba dostum !\n\n[verse]\nDar bir hüzün köprüsü geçsen geçilmez\nYarısında vazgeçersin\nAklına gelince geçmiş zaman haksızlıkları\nAğlar yüzüne hangi birisini seçsen seçilmez\nYine sen kaybedersin\n\n[chorus]\nToparla kendini onlara lazımsın\nSorarlarsa , onlar olmadan yarımsın , sakın !\nKendi kendine , içine içine hazmedersin , bunu bilirsin\nBir tek sen sabredersin\n\n[chorus]\nToparla kendini onlara lazımsın\nSorarlarsa , onlar olmadan yarımsın , sakın !\nKendi kendine , içine içine hazmedersin , bunu bilirsin\nBir tek sen sabredersin\n\n[Intro]\n\n[verse]\nDar bir hüzün köprüsü geçsen geçilmez\nYarısında vazgeçersin\nAklına gelince geçmiş zaman haksızlıkları\nAğlar yüzüne hangi birisini seçsen seçilmez\nYine sen kaybedersin\n\n[chorus]\nToparla kendini onlara lazımsın\nSorarlarsa , onlar olmadan yarımsın , sakın !\nKendi kendine , içine içine hazmedersin , bunu bilirsin\nBir tek sen sabredersin\n\n[chorus]\nToparla kendini onlara lazımsın\nSorarlarsa , onlar olmadan yarımsın , sakın !\nKendi kendine , içine içine hazmedersin , bunu bilirsin\nBir tek sen sabredersin\n\n[outro]\n\nKendime iyi bak dostum !\nAllaha ısmarladık...\n\n**Yorumum:**\n\n\"Merhaba dostum\" ile başlayıp \"Kendime iyi bak dostum\" ile biten bir şarkı — başlangıç ve bitiş aynı kişiye. Bu albümün en içten, en kırılgan anı. Köprünün yarısında duran, haksızlıkları aklına gelen, yine de \"toparla kendini\" diyen biri. Kendine hem yük hem destek olan birinin monologu.\n\n───\n\n**Style Prompt:**\n\n`Intimate electronic ballad, warm melancholic male vocals like a private conversation with the mirror, soft glowing synth pads, delicate piano notes scattered like memories, subtle electronic heartbeat underneath, bittersweet and fragile, not dramatic — quiet and personal, the sound of someone sitting alone and choosing to be okay anyway, tender farewell energy wrapped in gentle electronic warmth`",
    "category": "en_iyiler"
  },
  {
    "id": 481,
  ...
  },
  {
    "id": 495,
    "title": "[Intro]",
    "body": "[Intro]\n\nŞşş\n\n[chorus]\n\nAslında var olmakta ne kadar zorsun\nBunu da bilenler bilmeyenlere sorsun\nKandırabileceğin bir kalp değil bu affettiğin\nMazeretler yaratıp her şeyi mahvettiğin.\n\n[verse]\n\nSesimin ulaştığı yere bakın\nMesafe yerden göğe daha yakın\nDuyanlar duymayanlara \nGörenler görmeyenlere\nHissedenler hissetmeyenlere anlatsın\nKimse kimseyi incitmesin sakın\nHerkesi filikalara alın\n\n[chorus]\n\nAslında var olmakta ne kadar zorsun\nBunu da bilenler bilmeyenlere sorsun\nKandırabileceğin bir kalp değil bu affettiğin\nMazeretler yaratıp her şeyi mahvettiğin.\n\n[chorus]\n\nAslında var olmakta ne kadar zorsun\nBunu da bilenler bilmeyenlere sorsun\nKandırabileceğin bir kalp değil bu affettiğin\nMazeretler yaratıp her şeyi mahvettiğin.",
    "category": "en_iyiler"
  },
  {
    "id": 496,
